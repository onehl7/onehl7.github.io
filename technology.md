...
<section class="max-w-4xl mx-auto my-12 px-4">
  <ul class="list-none p-0 m-0">
    ...
    <li class="border-l-4 border-teal-500 p-4 mb-3 rounded-r-md transition-colors topic-item">
      <a href="{{ post.url | relative_url }}" class="font-semibold text-lg text-primary no-underline hover:text-teal-400">{{ post.title }}</a>
